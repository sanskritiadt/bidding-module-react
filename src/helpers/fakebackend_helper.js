...
import { APIClientURL } from "./apiso_helper";

import * as url from "./url_helper";

const api = new APIClient();

const apiso = new APIClientURL();
...
// Login Method
export const postFakeLogin = data => api.create(url.POST_FAKE_LOGIN_N, data);

// OTP Method
export const postFakeOTP = data => api.createNew(url.POST_FAKE_OTP, data);

// postForgetPwd
export const postFakeForgetPwd = data => api.create(url.POST_FAKE_PASSWORD_FORGET + '?email=' + data.email, data);

export const postFakeResetPwd = data => api.create(url.POST_FAKE_PASSWORD_RESET, data);
...
export const getUserDataByCode = () => api.get(url.GET_USER_DATA_CODE, { "userCode": "cu000010" });
...
// Ecommerce
// get Products
export const getProducts = () => api.getTransporterData(url.GET_MATERIALS);

// delete Product
export const deleteProducts = product => api.delete(url.DELETE_PRODUCT + '/' + product);

// add Products
export const addNewProduct = product => api.createProductAdd(url.ADD_NEW_PRODUCT, product);

// update Products
export const updateProduct = product => api.createProductAdd(url.ADD_NEW_PRODUCT, product);

// get Orders
export const getOrders = () => api.getTransporterData(url.GET_ORDERS);
...
// get Customers
export const getCustomers = () => api.getTransporterData(url.GET_CUSTOMERS);

// get Customers
export const getClusters = () => api.get(url.GET_CLUSTERS);

// get Plants
export const getPlants = () => api.get(url.GET_PLANTS);

// get Quotas
export const getProcessingList = () => api.getJBPMData(url.GET_PROCESS);

// get Quotas
export const getQuotas = () => api.getTransporterData(url.GET_QUOTA + "?customer_code=CU000091");

// get Roles
export const getRoles = () => api.get(url.GET_CUSTOMERS);

// get Vehicle
export const getVehicle = () => api.getTransporterData(url.GET_VEHICLES);

// get Material
export const getMaterial = () => api.getTransporterData(url.GET_MATERIALS);

// get Cleaner
export const getCleaner = () => api.getTransporterData(url.GET_CLEANER);

// get Drivers
export const getDriver = () => api.getTransporterData(url.GET_DRIVERS);
...
export const getUsers = () => {
  ...
  return api.get(url.GET_USERS + `?plantCode=${plantcode}`);
};

// get Customers
export const getReportIndent = (data) => api.create(url.GET_INDENT_REPORTS, data);

// get Vehicles
export const getVehicles = () => api.getTransporterData(url.GET_VEHICLES);

// get Transporters
export const getTransporters = () => api.getTransporterData(url.GET_TRANSPORTERS);

// add Customers
export const addNewCustomer = customer => api.createCustomAdd(url.ADD_NEW_CUSTOMER, customer);

// add Cleaners
export const addNewCleaner = cleaner => api.createCustomAdd(url.ADD_NEW_CLEANER, cleaner);

// add cLUSTER
export const addNewCluster = cluster => api.create(url.ADD_NEW_CLUSTER, cluster);

// add PLANT
export const addNewPlant = plant => api.create(url.ADD_NEW_PLANT, plant);

// add Vehicle
export const addNewVehicle = vehicle => api.createCustomAdd(url.ADD_NEW_VEHICLE, vehicle);

// add raise indent
export const addNewRaiseIndentData = raiseIndent => api.createJBPMAdd(url.ADD_NEW_RAISE_INDENT, raiseIndent);

// add Transporter
export const addNewTransporter = transporter => api.createCustomAdd(url.ADD_NEW_TRANSPORTER, transporter);

// add Driver
export const addNewDriver = driver => api.createCustomAdd(url.ADD_NEW_DRIVER, driver);

// add Driver
export const addNewQuota = quota => api.createCustomAdd(url.ADD_NEW_QUOTA, quota);

// add REPORT INDENT
export const addNewReportIndent = reportIndent => api.create(url.GET_INDENT_REPORTS, reportIndent);

// add CANCEL REPORT INDENT
export const addNewCancelReportIndent = reportCancelIndent => api.create(url.GET_CANCEL_INDENT_REPORTS, reportCancelIndent);

// add SCHEDULED REPORT INDENT
export const addNewScheduleReportIndent = reportScheduleIndent => api.create(url.GET_SCHEDULE_INDENT_REPORTS, reportScheduleIndent);

// update Customers
export const updateCustomer = customer => api.put(url.UPDATE_CUSTOMER + '/' + customer.id, customer);

// update Cluster
export const updateCluster = cluster => api.put(url.UPDATE_CLUSTER + '/' + cluster.id, cluster);

// update Plant
export const updatePlant = plant => api.put(url.UPDATE_PLANT + '/' + plant.id, plant);

// update report indent
export const updateReportIndent = customer => api.update(url.UPDATE_CUSTOMER + '/' + customer._id, customer);

// delete Customers
export const deleteCustomer = customer => api.delete(url.DELETE_CUSTOMER + '/' + customer);

// delete report indent
export const deleteReportIndent = customer => api.delete(url.DELETE_CUSTOMER + '/' + customer);
...
// Tasks
// get Task
export const getTaskList = () => api.getDashboardData(url.GET_TASK_LIST);
...
// get Leads
export const getLeads = () => api.getTransporterData(url.GET_LEADS);

// add Lead
export const addNewLead = lead => api.createCustomAdd(url.ADD_NEW_LEAD, lead);

// update Lead
export const updateLead = lead => api.putData(url.UPDATE_LEAD, lead);

// delete Lead
export const deleteLead = lead => api.deleteData(url.DELETE_LEAD + '?productCategory=' + lead);
...
// Pages > Team
export const getTeamData = (team) => api.getTransporterData(url.GET_TEAMDATA, team);
...
// To Do
export const getTodos = () => api.getTransporterData(url.GET_TODOS);
export const deleteTodo = (todo) => api.deleteData(url.DELETE_TODO + '?id=' + todo);
export const addNewTodo = (todo) => api.createCustomAdd(url.ADD_NEW_TODO, todo);
export const updateTodo = (todo) => api.putData(url.UPDATE_TODO, todo);
