...
const StageUpdate = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: (cell) => {
              return <span className="badge text-uppercase badge-soft-danger"> Submit </span>;
          }
      },
      // {
      //   Header: "Action",
  ...
  document.title = "Stage Update | EPLMS";
  return (
    <React.Fragment>
      <div className="page-content">
        ...
        />
        <Container fluid>
          <BreadCrumb title="Stage Update" pageTitle="Reports" />
          <Row>
            <Col lg={12}>
                ...
                <CardHeader className="border-0">
                  <Row className="g-4 align-items-center">
                    <div className="col-sm">
                      <div>
                        <h5 className="card-title mb-0 bg-light">Stage Update Reports</h5>
                      </div>
                    </div>
                  ...
                  <Row className="mt-4">
                    ...
                    <Col lg={3}>
                      <div>
                        ...
                        >
                          ...
                          {Material.map((item, key) => (<option value={item.code} key={key}>{item.materialTypesCode}</option>))}
                        </React.Fragment>
                        </Input>
                      </div>
                    </Col>
                    ...
                    <Col lg={3}>
                      <div>
                        <Label className="form-label" >Stage Name<span style={{ color: "red" }}>*</span></Label>
                        <Input
                ...
                <div className="card-body pt-0 mt-5">
                  <div>
                    ...
                    <TableContainer
                      ...
                      SearchPlaceholder='Search for PMR Reports Name or something...'
