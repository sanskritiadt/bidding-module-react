...
const Team = () => {
    document.title = "Material | Nayara";
    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Material" pageTitle="Pages" />
                    <Card>
                        <CardBody>
                            <Row className="g-2">
                                <Col sm={4}>
                                    <div className="search-box">
                                        <Input type="text" className="form-control" placeholder="Search for material name..." onChange={(e) => searchList(e.target.value)} />
                                        <i className="ri-search-line search-icon"></i>
                                    </div>
                                </Col>
                                <Col className="col-sm-auto ms-auto">
                                    <div className="list-grid-nav hstack gap-1">
                                        <Link color="info" to="/products" className="btn btn-soft-info nav-link btn-icon fs-14 active filter-button"><i className="ri-grid-fill"></i></Link>
                            ...
                            <div id="teamlist">
                                <Row className="team-list grid-view-filter">
                                    {(teamList || []).map((item, key) => (
                                        <Col key={key} className="setWidth">
                                            <Card className="team-box">
                                                <div className="team-cover">
                                                    <img src={process.env.PUBLIC_URL+"/subImage/"+item.image[0]} alt="" className="img-fluid" />
                                                </div>
                                                <CardBody className="">
                                                    <Row className="align-items-center team-row">
                                                        ...
                                                        <Col lg={2} className="col">
                                                            <div class="">
                                                            <Link to={'/apps-ecommerce-product-details/'+item.material_code}><h5 className="fs-16 mb-1">{item.material_name}</h5></Link>
                                                            </div>
