...
const Plant360IB = () => {
    ...
    const getDispatchSummaryData = async (plantCode) => {
        try {
            const res = await axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/sales-dispatch-dashboard/getDispatchSummaryData/${plantCode}/IB`, config)
                .then(res => {
    ...
    const getPlantMovementSummary = async (plantCode) => {
        ...
        try {
            const res = await axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/sales-dispatch-dashboard/getPlantMovementSummaryData/${plantCode}/IB`, config)
                .then(res => {
    ...
    const getYard_Detention = async (plantCode) => {
        ...
        try {
            const res = await axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/sales-dispatch-dashboard/getDashboardData/${plantCode}/IB`, config)
                .then(res => {
    ...
    const getLoaderData = async (plantCode) => {
        try {
            var array1 = [];
            var array2 = [];
            await axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/sales-dispatch-dashboard/getLoaderData/${plantCode}/IB`, config)
                .then(res => {
            ...
            await axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/packerLoader/getPackerDataByTypePandUL?plantCode=${plantCode}`, config)
                .then(res => {
                    const data = res;
    ...
    const getPackerData = async (plantCode) => {
        try {
            await axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/sales-dispatch-dashboard/getPackerData/${plantCode}/IB`, config)
                .then(res => {
    ...
    const triggerCountData = async (stageName) => {
        ...
        try {
            const res = await axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/sales-dispatch-dashboard/getPlantMovementSummaryData?plant_code=${plantCode}&stage_code=${stageName}&Movement=IB`, config)
                .then(res => {
    ...
    document.title = "Plant 360 Dashboard-IB";
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Plant 360 Dashboard-IB" pageTitle="Dashboard" />
                    <Row>
                        <Col lg={12}>
