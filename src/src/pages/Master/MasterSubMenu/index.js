...
import '../MasterSubMenu/SubMenu.css';
...
const MasterSubMenu = () => {
  ...
  const getAllDeviceData = () => {
    ...
    axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/submenus`, config)
      .then(res => {
        const device = res;
        setDevice(device);
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEdit) {
        const res = await axios.put(`${process.env.REACT_APP_LOCAL_URL_8082}/submenus/${CurrentID}`, values, config)
        console.log(res);
        toast.success("Sub Menu Updated Successfully", { autoClose: 3000 });
        getAllDeviceData();
      }
      else {
        const res = await axios.post(`${process.env.REACT_APP_LOCAL_URL_8082}/submenus`, values, config)
        console.log(res);
        if (!res.errorMsg) {
    ...
    axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/submenus/${id}`, config)
      .then(res => {
        ...
        setValues({
          ...values,
          "name": result.name,
          "mainmenuName": result.mainmenuName,
                ...
                <CardHeader className="border-0">
                  <Row className="g-4 align-items-center">
                    <div className="col-sm">
                      <div>
                        <h5 className="card-title mb-0 bg-light">Sub Menu Details</h5>
                      </div>
                    </div>
                ...
                <div className="card-body pt-0">
                  <div>
                    ...
                    <TableContainer
                      ...
                      SearchPlaceholder='Search for Sub Menu Name or something...'
                    />
                  </div>
                        ...
                        <Row className="g-3">
                          ...
                          <Col md={4}>
                            ...
                            <Input
                              ...
                              required
                            >
                              <option value={""}>{"Select Main Menu Name"}</option>
