...
const YardGraphDataIB = () => {
    ...
    const graphData = async (plantcode) => {
        await axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/ib-yard-in/waitingVehicle/${plantcode}`, config)
            .then(res => {
                const allData = res;
...
export default memo(YardGraphDataIB);
