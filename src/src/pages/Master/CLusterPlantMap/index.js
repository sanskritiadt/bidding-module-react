...
const CusterPlantMap = () => {
  const dispatch = useDispatch();

  const { clusters, plants, isCleanerCreated, isCleanerSuccess, error } = useSelector((state) => ({
    plants: state.Master.plants,
      ...
      <>
        <tr key={index}>
          ...
          <td className="p-1 text-end">
            ...
            ><button type="button" className="btn btn-sm btn-outline-success waves-effect waves-light border-success">View Document</button>
            </Link>
          </td>
        </tr>
      </>
            ...
            Cell: (cellProps) => {
                ...
                <ul className="list-inline hstack gap-2 mb-0">
                    ...
                    <Link
                        to="#"
                        className="text-primary d-inline-block edit-item-btn"
                        onClick={() => { const customerData = cellProps.row.original.clusterCode; setViewModal(); }}
                    >
                    ...
                    <Link
                        ...
                        onClick={() => { const clusterNumber = cellProps.row.original.clusterCode; setViewModal(); }}
                    >
    ...
    () => [
      {
        Header: "#",
        Cell: (cell) => {
            return <input type="checkbox" className="productCheckBox form-check-input" value={cell.row.original.id} onClick={() => "" } />;
        },
      },
      {
        Header: "Cluster Code",
  ...
  const CustomInputComponent = ({
    ...
    <div>
      <input {...field} {...props} className={(touched[field.name] &&
        ...
        errors[field.name] && <div type="invalid" className="invalid-feedback">{errors[field.name]}</div>}
                ...
                <Row>
                    ...
                    <Card id="customerList">
                        ...
                        <Row className="g-4 align-items-center">
                            ...
                            <div>
                                <h5 className="card-title mb-0 bg-light ">Cluster Plant Mapping List</h5>
                            </div>
                            </div>
                            ...
                            <div>
                                ...
                                >
                                <i className="ri-add-line align-bottom me-1"></i> Map Plant Cluster
                                </button>{" "}
                        ...
                        <Row className="g-3">
                        <Col lg={5}>
                            <select id="clusterPlantMap" className="form-control">
                                <option value=""> -- Select Cluster -- </option>
                                {
                                clusters.map(function (value, index) {
                                    return(
                                        <option key={index} value={value.clusterCode}>{value.clusterName}</option>
                                    );
                                })
                                }
                            </select>
                        ...
                        <Col lg={5}>
                            <button
                                ...
                                onClick={() => { "" }}
                                >
                                <i className="ri-add-line align-bottom me-1"></i> Search
                            </button>
                        </Col>
                    </Row>                    
                      {/**<TableContainer
            ...
            <Row className="g-3">
                ...
                <Col lg={5}>
                    <button
                        ...
                        onClick={() => { setViewModal(); }}
                        >
                        <i className="ri-add-line align-bottom me-1"></i> Map With Plants
                    </button>
                </Col>
            </Row>
            <TableContainer
