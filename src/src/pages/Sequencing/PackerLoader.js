...
const PackerLoader = () => {
    ...
    const getAllPackerLoader = async (plantcode) => {debugger;
        try{
            await axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/packerLoader/getAllPackerLoader?plantCode=${plantcode}`, config)
            .then(res => {
                const data = res;
                if(res.errorMsg){
                    setPackerLoader([]);
                                        ...
                                        <Form className="tablelist-form" onSubmit={handleSubmit}>
                                            <ModalBody>
                                                <Row className="g-3">
                                                    ...
                                                    <Col lg={4}>
                                                        <div>
                                                            ...
                                                            >
                                                                ...
                                                                <option value={"Amazin"}>{"Amazin"}</option>
                                                    ...
                                                    <Col md={isEdit ? 12 : 12} className="hstack gap-2 justify-content-end" style={{ marginTop: "45px" }}>
