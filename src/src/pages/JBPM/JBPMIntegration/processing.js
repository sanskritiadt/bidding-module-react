...
/*
  ...
  */
  ...
  document.title = "Processing | Nayara - React Admin & Dashboard Template";
  return (
    <React.Fragment>
      <div className="page-content">
        ...
        />
        <Container fluid>
          <BreadCrumb title="Process" pageTitle="Master" />
          <Row>
            <Col lg={12}>
                ...
                <CardHeader className="border-0">
                  <Row className="g-4 align-items-center">
                    <div className="col-sm">
                      <div>
                        <h5 className="card-title mb-0">Processing List</h5>
                      </div>
                    </div>
...
export default MasterJBPMProcessing;
