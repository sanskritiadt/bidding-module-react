    ...
    const customerstatus = [
        {
            options: [
                ...
                { label: "Customer Approval", value: "BlocCustomer Approvalk" },
...
const IndentStatusFilter = () => {
    const [statusData, setAllStatusData] = useState([]);
    const [getStatus, setStatus] = useState("");

    useEffect(() => {
        axios.get(`${process.env.REACT_APP_LOCAL_URL_8042}/indentModule/indent/getIndentStatus`)
            .then(res => {
                const statusData = res.options;
    ...
    const dropdownOption = statusData;
    return (
        <React.Fragment>
            <Col xl={7}>
                <Row className="g-3">
                    ...
                    <Col sm={4}>
                        <div>
                            ...
                            >
                                {" "}
                                <i className="ri-search-fill me-2 align-bottom"></i>
                                Search
                            </button>
                        </div>
                    </Col>
...
const ReportScheduledFilter = () => {
    const [customerStatus1, setcustomerStatus1] = useState(null);

    function handlecustomerStatus1(cus) {
        
        setcustomerStatus1(cus);
    }

    const customerstatus12 = [
        {
            options: [
                ...
                { label: "Nitu", value: "Nitu" },
                { label: "Dheeraj", value: "Dheeraj" },
            ],
        },
    ];
    return (
                    ...
                    <Col sm={4}>
                        <div>
                            <Select
                                ...
                                onChange={(e) => {
                                    handlecustomerStatus1(e);
                                }}
                                options={customerstatus12}
                                name="choices-single-default"
                                id="idStatus"
                            ></Select>
                        </div>
