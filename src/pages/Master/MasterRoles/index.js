...
const MasterRoles = () => {
  ...
  const handleCustomerClick = useCallback((arg) => {
    ...
    toggle();
    const id = arg;
    axios.get(`${process.env.REACT_APP_LOCAL_URL_8082}/roles/${id}`, config)
      .then(res => {
        const result = res;
        setValues({
          ...values,
  ...
  const handleDeleteCustomer = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.delete(`${process.env.REACT_APP_LOCAL_URL_8082}/roles/${CurrentID}`, config)
                ...
                <CardHeader className="border-0">
                  <Row className="g-4 align-items-center">
                    <div className="col-sm">
                      <div>
                        <h5 className="card-title mb-0 bg-light">Roles Details</h5>
                      </div>
                    </div>
                ...
                <div className="card-body pt-0">
                  <div>
                    ...
                    <TableContainer
                      ...
                      SearchPlaceholder='Search for Roles Name or something...'
                    />
                  </div>
                    ...
                    <Form className="tablelist-form" onSubmit={handleSubmit}>
                      <ModalBody>
                        <Row className="g-3">
                          ...
                          <Col md={4}>
                            <Label htmlFor="validationDefault03" className="form-label">Icon</Label>
                            <Input type="text" required className="form-control"
                        ...
                        <Col md={12} className="hstack gap-2 justify-content-end" style={{ marginTop: "45px" }}>
                          ...
                          <button type="submit" className="btn btn-success"> {!!isEdit ? "Update" : "Add Roles"} </button>
                        </Col>
