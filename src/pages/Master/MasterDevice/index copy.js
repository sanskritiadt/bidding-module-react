...
const MasterDevice = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if(name === "deviceType" && value === "INVOICE"){
      setPrinter(true);
    }
    setValues({
      ...values,
                    ...
                    <Form className="tablelist-form" onSubmit={handleSubmit}>
                      <ModalBody>
                        <Row className="g-3">
                          ...
                          {printer &&
                            <Col md={4}>
                              <Label htmlFor="validationDefault04" className="form-label">Printer Name</Label>
                              <Input type="text" required className="form-control"
                          ...
                          {/* <Col md={4}>
                            <Label htmlFor="validationDefault04" className="form-label">Location Code</Label>
                            <Input type="number" required className="form-control"
                              id="validationDefault04"
                              name="locationName"
                            ...
                            <div>
                              ...
                              >
                                ...
                                {PlantStage.map((item, key) => (
                                  <option value={item.plantCode} key={key}>{item.locationName}</option>)
                                )}
                              </Input>
                            </div>
                          </Col>
