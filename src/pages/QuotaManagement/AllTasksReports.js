...
//   }, [taskList]);
  ...
  const columns = useMemo(
    () => [
      ...
      {
        Header: "Average Yard TAT (Hr:Min)",
        accessor: "project11",
        filterable: false,
      },
      {
        Header: "Average Yard TAT (Min)",
        accessor: "project10",
        filterable: false,
      },
      {
        Header: "Medium Yard TAT (Hr:Min)",
        accessor: "project9",
        filterable: false,
      },
      {
      ...
      {
        Header: "Average Plant TAT (Hr:Min)",
        accessor: "project6",
        filterable: false,
      },
      {
        Header: "Average Plant TAT (Min)",
        accessor: "project2",
        filterable: false,
      },
      {
        Header: "Medium Plant TAT (Hr:Min)",
        accessor: "project1",
        filterable: false,
      },
      {
        Header: "Medium Plant TAT (Min)",
        accessor: "status",
        filterable: false,
      },
      {
        Header: "Months Of Year",
        accessor: "task1",
        filterable: false,
      },
    ],
