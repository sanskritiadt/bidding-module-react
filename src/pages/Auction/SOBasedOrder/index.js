...
//       try {
//         // Format dates for API - FIXED to use ISO format
//         const formatDate = (dateString) => {
//           if (!dateString) return "";
          
//           // Make sure we're sending in the ISO format
...
//             return {
//               soNumber: orderDetails.orderNo,
//               validity: formatDate(new Date()), // Use current date in ISO format
//               material: orderDetails.material,
//               quantity: parseInt(orderDetails.quantity.toString().replace(/\D/g, '')),
...
//           Your SO Based <span style={{color:"blue"}}> {bidNo}</span>  has been created!
//         </h3>
//         <button
//           type="button"
