...
//this code is working fine but refresh kaam nahi kar raha hai 
    ...
    if (activeStep === 2) {
      ...
      try {
        ...
        if (!submitError && !isSubmitting) {
          ...
          // We need to access the parent component's fetchBidNo function
          // We can use a custom event to notify the parent component
