...
const LinewithDataLabels = ({ dataColors }) => {
    ...
    var series = [{
        name: "Total",
        data: [totalVehicle, wqCount, rqCount]
    },/*
    {
        name: "Low - 2018",
        data: [24, 21, 26, 22, 27, 23, 22]
    },    
    {
        name: "Very Low - 2018",
        data: [12, 10, 15, 13, 16, 11, 10]
    }*/
    ];
    var options = {
        chart: {
...
const LinewithDataLabelsOB = ({ dataColors }) => {
    ...
    var series = [{
        name: "Total",
        data: [totalVehicle, wqCount, rqCount, wqClinker, rqClinker]
    },/*
    {
        name: "Low - 2018",
        data: [24, 21, 26, 22, 27, 23, 22]
