...
// const BidConfirmationModal = ({ isOpen, toggle, bidData ,loginCode}) => {
...
//         transporterCode: loginCode, // This should come from user context
...
// const DeliveryStatusChart = ({ withInTimeLimit, outOFTimeLimit, loginCode }) => {
...
//   const fetchDeliveryStatusData = async (loginCode) => {
//     try {
//       // Basic auth credentials
//       const credentials = btoa(`${process.env.REACT_APP_API_USER_NAME}:${process.env.REACT_APP_API_PASSWORD}`);


//       const response = await fetch(`${process.env.REACT_APP_LOCAL_URL_8082}/transporterBidding/getDeliveryStatus?transporterCode=${loginCode}`, {
//         method: 'GET',
//         headers: {
//           'Accept': '*/*',
//           'Content-Type': 'application/json',
...
//   const fetchBidStatusData = async (loginCode) => {
//     try {
//       // Basic auth credentials
//       const credentials = btoa(`${process.env.REACT_APP_API_USER_NAME}:${process.env.REACT_APP_API_PASSWORD}`);

//       const response = await fetch(`${process.env.REACT_APP_LOCAL_URL_8082}/transporterBidding/getBidStatusByTransporterCode?transporterCode=${loginCode}`, {
//         method: 'GET',
//         headers: {
...
//                     <div className="spinner-border" role="
//                     status" aria-hidden="true"></div>
