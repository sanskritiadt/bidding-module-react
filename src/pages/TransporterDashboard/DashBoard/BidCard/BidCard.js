...
//is code se saari bids show hongi 
// import React, { useState, useEffect } from "react";
// import { Card, CardBody, Col, Row } from "reactstrap";
// import './BidCard.css';
...
//     const fetchMinimalBids = async () => {
//       try {
//         const response = await fetch(`${process.env.REACT_APP_LOCAL_URL_8082}biddingMaster/getMinimalBidsByTransporterCode?transporterCode=T-000008`, {
//           method: 'GET',
//           headers: {
//             'accept': 'application/json',
//             'Authorization': 'Basic YW1hemluOlRFQE0tV0BSSw=='
