...
const ToleranceAuditReport = () => {
    ...
    const getAllDeviceData = async () => {
        ...
        if (values.start_date === "") {
            ...
            try {
                await axios.post(`${process.env.REACT_APP_LOCAL_URL_REPORTS}/getReport/toleranceAuditLog`, values, config)
                    .then(res => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                Header: "Gross Weight",
                accessor: "WEMT_WEIGHT",
                filterable: false,
            },
            {
                Header: "Net Weight",
                accessor: "WEMT_NET_WEIGHT",
                filterable: false,
            },
            {
                Header: "No of Bags",
            ...
            {
                Header: "Approved By 1st Dept",
                accessor: "WEMT_LEVEL1_APPROVAL_BY",
                filterable: false,
            },
            {
                Header: "Approval Time",
                accessor: "WEMT_LEVEL1_APPROVAL_TIME",
                filterable: false,
            },
            {
                Header: "Remarks",
                accessor: "WEMT_LEVEL1_TOLERENCE_REMARKS",
                filterable: false,
            },
            {
                Header: "Approved By 2nd Dept",
                accessor: "WEMT_LEVEL2_APPROVAL_BY",
                filterable: false,
            },
            {
                Header: "Approval Time",
                accessor: "WEMT_LEVEL2_APPROVAL_TIME",
                filterable: false,
            },
            {
                Header: "Remarks",
                accessor: "WEMT_LEVEL2_TOLERENCE_REMARKS",
                filterable: false,
            },
            // {
            //     Header: "User ID",
    ...
    const downloadCSV = () => {
        ...
        FileSaver.saveAs(blob, 'ToleranceAuditReports.xlsx');
    ...
    document.title = "Tolerance Audit Report | EPLMS";
    return (
        <React.Fragment>
            <div className="page-content">
                ...
                />
                <Container fluid>
                    <BreadCrumb title={"Tolerance Audit Report"} pageTitle="Reports" />
                    <Row>
                        <Col lg={12}>
                                ...
                                <CardHeader className="border-0">
                                    <Row className="g-4 align-items-center">
                                        <div className="col-sm">
                                            <div>
                                                <h5 className="card-title mb-0 bg-light">Tolerance Audit Report Details</h5>
                                            </div>
                                        </div>
...
export default ToleranceAuditReport;
