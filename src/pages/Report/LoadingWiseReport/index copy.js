...
const LoadingWiseReport = () => {
    ...
    const getHeaderName = () => {
        ...
        const obj = JSON.parse(main_menu).menuItems[9].subMenuMaster.name;
        setHeaderName(obj);
      }
    ...
    const downloadCSV = () => {
        ...
        a.href = url;
        a.download = 'LoadingWiseReports.csv';
    ...
    const firstData = [
        {
            ...
            "reason": "--",
            "diffCount": "0",
            "startTime": "27-11-2023 12:07:00",
            "endTime": "27-11-2023 12:42:00",
        },
        {
            "id": 1,
            "ldrNo": "1",
            "truck-wagonNO": "MP16H1666",
            "ldrNumber": "TL1",
            "grade": "43",
            "destination": "--",
            "target": "600",
            ...
            "reason": "--",
            "diffCount": "0",
            "startTime": "27-11-2023 01:07:00",
            "endTime": "27-11-2023 01:42:00",
        },
        {
            "id": 1,
            "ldrNo": "1",
            "truck-wagonNO": "MP09HH1758",
            "ldrNumber": "TL1",
            "grade": "43",
            "destination": "--",
            "target": "500",
            ...
            "reason": "--",
            "diffCount": "0",
            "startTime": "27-11-2023 02:07:00",
            "endTime": "27-11-2023 02:42:00",
        },
        {
            "id": 1,
            "ldrNo": "1",
            "truck-wagonNO": "UP70JT5858",
            "ldrNumber": "TL1",
            "grade": "43",
            "destination": "--",
            "target": "600",
            ...
            "reason": "--",
            "diffCount": "0",
            "startTime": "27-11-2023 03:07:00",
            "endTime": "27-11-2023 03:42:00",
        },
        {
            "id": 1,
            "ldrNo": "2",
            "truck-wagonNO": "MP09HH6897",
            "ldrNumber": "TL2",
            "grade": "OPC43",
            "destination": "--",
            "target": "600",
    ...
    const columns = useMemo(
        () => [
            ...
            {
                Header: "TRUCK/WAGON NO.",
                accessor: "truck-wagonNO",
                filterable: false,
            },
            {
                Header: "LDR NO",
    ...
    document.title = "Loading Wise Reports" + " || EPLMS";
    return (
        <React.Fragment>
            <div className="page-content">
                ...
                />
                <Container fluid>
                    <BreadCrumb title={"Loading Wise Reports"} pageTitle="Reports" />
                    <Row>
                        <Col lg={12}>
                                ...
                                <CardHeader className="border-0">
                                    <Row className="g-4 align-items-center">
                                        <div className="col-sm">
                                            <div>
                                                <h5 className="card-title mb-0 bg-light">Loading Wise Reports</h5>
                                            </div>
                                        </div>
...
export default LoadingWiseReport;
